...
//        System.out.println(input + "\n>>>\n" + nimoy.poem(input));
        final GraphPoet newNimoy = new GraphPoet(new File("src/P1/poet/myPoemData2.txt"));
        final String myInput = "The important idea brings parents and children together. $";
        System.out.println(myInput + "\n>>>\n" + newNimoy.poem(myInput));
    }
